<div class="row">
    <div class="col s12 m4">
        <div class="card blue-grey darken-1 cardDisplay">
            <div class="card-content white-text">
                <span class="card-title">Nombre de camion affectés</span>
    ...
    <div class="col s12 m4">
        <div class="card blue-grey darken-1 cardDisplay">
            <div class="card-content white-text">
                <span class="card-title">Nombre de camion libres</span>
    ...
    <div class="col s12 m4">
        <div class="card blue-grey darken-1 cardDisplay">
            <div class="card-content white-text">
                <span class="card-title">Nombre d'utilisateurs</span>
    ...
    <div class="col s12 m4">
        <div class="card blue-grey darken-1 cardDisplay">
            <div class="card-content white-text">
                <span class="card-title">Nombre de missions</span>
